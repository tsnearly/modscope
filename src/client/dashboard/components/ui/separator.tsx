...
const Separator = React.forwardRef<HTMLDivElement, SeparatorProps>(
    (
        { className, orientation = "horizontal", vertical = false, variant, text, spacing, gap, style, ...props },
        ref
    ) => {
            ...
            return (
                <div
                    className={cn(
                        ...
                        finalOrientation === "horizontal" ? "w-full flex-row" : "h-full flex-col",
                        className
                    )}
                    ref={ref}
                    data-flux-separator=""
                ...
                >
                    ...
                    <span
                        className={cn(
                            finalOrientation === "horizontal" ? "px-2" : "py-2"
                        )}
                    >
                        {text}
                    </span>
        ...
        return (
            <div
                ...
                data-flux-separator=""
                aria-orientation={finalOrientation}
                className={cn(separatorVariants({ orientation: finalOrientation, variant, className }))}
                style={mergedStyle}
                {...props}
            />
        )
