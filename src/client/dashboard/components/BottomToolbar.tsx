    ...
    [
      {
        ...
        align: 'center',
        label: 'Report',
        icon: new URL('../../assets/glass-trend.png', import.meta.url).href,
      },
      {
        view: 'config',
        align: 'center',
        label: 'Config',
        icon: new URL('../../assets/glass-adjust.png', import.meta.url).href,
      },
      {
        view: 'schedule',
        align: 'center',
        label: 'Schedule',
        icon: new URL('../../assets/glass-schedule.png', import.meta.url).href,
      },
      {
        view: 'about',
        align: 'center',
        label: 'About',
        icon: new URL('../../assets/glass-about.png', import.meta.url).href,
      },
    ];
