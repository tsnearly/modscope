...
export async function generateHtml(
    ...
    try {
        ...
        const cssVarNames = [
            ...
            '--color-border', '--color-error', '--border-strong',
            '--radius-md', '--radius-lg', '--shadow-sm', '--shadow-md',
            // Heatmap gradient
            '--heatmap-0', '--heatmap-1', '--heatmap-2', '--heatmap-3',
            '--heatmap-4', '--heatmap-5', '--heatmap-6', '--heatmap-7',
            '--heatmap-8', '--heatmap-9',
            // Chart colours
            '--chart-primary', '--chart-secondary', '--chart-tertiary',
            '--chart-light', '--chart-accent', '--chart-highlight',
            // Component tokens
            '--card-bg', '--card-border', '--card-header-text', '--card-body-text',
            '--nav-bg', '--nav-border', '--nav-item-active-bg', '--nav-item-active-text',
            '--btn-primary-bg', '--btn-primary-text', '--btn-primary-hover',
            '--text-primary', '--text-secondary', '--text-muted',
            '--bg-surface', '--border-default', '--border-subtle',
            '--tab-active-bg', '--tab-active-border', '--tab-active-text',
        ];
