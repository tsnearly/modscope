...
import { ConfigSettings, CalculationSettings, DEFAULT_CALCULATION_SETTINGS } from '../../shared/types/settings';
...
export class ConfigService {
    ...
    async updateCalculationSettings(newSettings: Partial<CalculationSettings>): Promise<ConfigSettings> {
        const currentConfig = await this.getConfig();
